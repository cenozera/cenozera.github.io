...
<a href="#" class="nes-badge is-icon">
  ...
  },*/
  {
    ...
    code: `<section class="icon-list">
  <!-- twitter -->
  <a href="https://twitter.com/cenozerra" target="_blank"><i class="nes-icon twitter is-large"></i></a>

  <!-- facebook -->
  <a href="https://www.facebook.com/cenoz3ra" target="_blank"><i class="nes-icon facebook is-large"></i></a>

  <!-- instagram -->
  <a href="https://www.instagram.com/cenozera/" target="_blank"><i class="nes-icon instagram is-large"></i></a>
 ...
 <!-- <i class="nes-icon google is-large"></i>-->
  ...
  <!-- gmail -->
  <a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=info@cenozera.com&su=SUBJECT&body=BODY&tf=1" target="_blank"><i class="nes-icon gmail is-large"></i></a>
